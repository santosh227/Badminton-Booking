...
function CourtSelection({ courts, selectedCourt, onCourtSelect, isActive }) {
  ...
  return (
    <div className={`p-6 bg-white rounded-lg shadow-sm border ${isActive ? 'border-primary-200' : 'border-gray-200'}`}>
        ...
        {courts.map((court) => (
          ...
          >
            ...
            <div className="text-sm text-gray-600 mb-3">
              Base Price: <span className="font-medium text-gray-900">${court.basePrice}/hour</span>
            </div>
